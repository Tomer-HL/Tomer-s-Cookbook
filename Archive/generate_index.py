...
def extract_title_from_html(html_path: Path) -> str:
    """חילוץ כותרת מה-HTML, נפילה לשם התיקייה אם לא נמצא."""
    try:
...
def scan_cookbook(lang: str) -> dict[str, list[dict]]:
    """
    מחזיר: { category: [ {title, html_path, image_path}, ... ] }
    """
...
def main() -> None:
    ...
    for lang in ("en", "he"):
        ...
        print(f"✅  נוצר: cookbook/index_{lang}.html")

    print("\n📖 פתח את cookbook/index_en.html בדפדפן כדי לראות את האינדקס.")
